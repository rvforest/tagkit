...
def test_exif_tagdict_update_notimplemented():
    ...
    d2 = ExifTagDict()
    d2[(271, "IFD0")] = ExifTag(271, "Canon", "IFD0")
    d.update(d2)
...
def test_int_key_get_ambiguous():
    d = ExifTagDict()
    d[(271, "IFD0")] = ExifTag(271, "Canon", "IFD0")
    d[(271, "Exif")] = ExifTag(271, "Canon", "Exif")
...
def test_setitem_invalid_key_type():
    ...
    with pytest.raises(TypeError):
        d[271] = ExifTag(271, "Canon", "IFD0")  # type: ignore
    with pytest.raises(TypeError):
        d[(271, 123)] = ExifTag(271, "Canon", "IFD0")  # type: ignore
    with pytest.raises(TypeError):
        d[(271, "IFD0", "extra")] = ExifTag(271, "Canon", "IFD0")  # type: ignore
