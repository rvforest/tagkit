import pytest
from tagkit.tag_io.piexif_io import _conform_ifd_names, _tag_is_ascii, PiexifBackend, tagkit_to_piexif_ifd_map
...
def test_load_tags_and_save_tags():
    ...
    with patch('piexif.load', return_value=fake_raw) as mock_load, \
