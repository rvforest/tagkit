...
class ExifEntry:
    ...
    def format(self, render_bytes: bool = True, binary_format: Optional[str] = None) -> str:
        """
    ...
    def to_dict(self, render_bytes: bool = True, binary_format: Optional[str] = None) -> dict:
        ...
        return {
            "id": self.id,
            "name": self.name,
            "value": self.format(render_bytes=render_bytes, binary_format=binary_format),
            "ifd": self.ifd,
        }
